...
func_vars_random <- cbind(Tn2, P1 = P1$P1)

Tn2_ran <- runif(100, min = min(func_vars_random$Tn2), max = max(func_vars_random$Tn2))

results <- Tn2_ran %>% 
  map(~almond_model_test(df = func_vars_random, P1 = func_vars_random$P1, Tn2 = .x))
```
